...
from .widgets import ctk_file_explorer as f_explorer
...
class CTk(tkinter.Tk, CTkAppearanceModeBaseClass, CTkScalingBaseClass):
    ...
    def __init__(self,
        ...
        # esta instancia de la clase nos permite tener siempre disponbile el buscador de archivos
        self.file_explorer = f_explorer.CTkFileExplorer()
